    ...
    <>
      ...
      <div id="lead" ref={ref}>
        <div id="lead-content">
          ...
          <a download target="_blank" href="https://app.enhancv.com/share/37dd37cb/?utm_medium=growth&utm_campaign=share-resume&utm_source=dynamic" className="btn-rounded-white">
            Download Resume
          </a>
        </div>
        {/* <!-- End #lead-content --> */}
